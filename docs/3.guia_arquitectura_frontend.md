...
| Página          | Crear Usuario        | `pages/admin/CreateUser.tsx`    | Formulario para crear usuarios del sistema (solo admin)       |
...
- Si role === 'doctor': dropdown para seleccionar médico asociado
...
```tsx
/login                      → Login (público)
/                          → Redirect a /agenda-secretaria (protegido)
/agenda-secretaria         → AgendaSecretaria (admin/secretary)
/citas/nueva              → NuevaCita (admin/secretary)
/pacientes                → Pacientes (admin/secretary)
/agenda-medico            → AgendaMedico (admin/doctor)
/admin                    → AdminDashboard (admin)
/admin/usuarios/nuevo     → CreateUser (admin)
```
...
- **2025-11-20**  
  - Implementada página de creación de usuarios (`/admin/usuarios/nuevo`)
  - Formulario completo con validación y llamada a edge function
  - Protección de ruta solo para administradores
  - Agregado link "Crear Usuario" en navegación para admin
