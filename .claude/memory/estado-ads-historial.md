# Estado Ads — Historial

> Archivo historico. Lo vivo esta en `estado-ads.md`.
> No se carga automaticamente al activar /modo-ads.
> Snapshot tomado el 19 May 2026 (ads en pausa permanente desde el pivot 18 May).
> Campanas AD-005, AD-006, AD-007 con metricas finales completas.

---

# Estado Ads — OrionCare (snapshot)
